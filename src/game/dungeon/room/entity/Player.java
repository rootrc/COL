...
public class Player extends Entity {
    ...
    public void update() {
        ...
        if (inventory.hasNewItem()) {
            if (inventory.getItem().getName().equals("The Marrow Thieves")) {
                increaseLightStrength(75);
            } else if (inventory.getItem().getName().equals("The Boy in the Picture")) {
                increaseLightStrength(75);
            } else if (inventory.getItem().getName().equals("Hunting by Stars")) {
                increaseMaxSpeed(1);
            } else if (inventory.getItem().getName().equals("I Am Not Pocahontas")) {
                increaseMaxSpeed(1);
            } else if (inventory.getItem().getName().equals("Two-Eyed Seeing")) {
                increaseLightStrength(75);
            } else if (inventory.getItem().getName().equals("Constellation of Learning")) {
                increaseLightStrength(200);
            }
        }
    }
